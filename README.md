...
We'll use a Go web app named [podinfo](https://github.com/stefanprodan/podinfo) to test
...
We will use this metric to scale the Fargate tasks based on the number of requests per second.
